export class LancerCombatTracker extends CombatTracker {
    ...
    async _renderInner(data, options) {
        ...
        const settings = mergeObject(CONFIG.LancerInitiative.def_appearance, game.settings.get(CONFIG.LancerInitiative.module, "appearance"), { inplace: false });
        settings.enable_initiative = game.settings.get(CONFIG.LancerInitiative.module, "enable-initiative");
        html.find(".combatant").each((_, li) => {
            ...
            // Retrieve settings
            let color = "";
            switch ((_a = combatant.token) === null || _a === void 0 ? void 0 : _a.disposition) {
                case 1: // Player
...
//# sourceMappingURL=lancer-combat-tracker.js.map