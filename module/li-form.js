export class LIForm extends FormApplication {
    ...
    /** @override */
    getData(_) {
        return mergeObject(CONFIG.LancerInitiative.def_appearance, game.settings.get(CONFIG.LancerInitiative.module, "appearance"), { inplace: false });
    }
    /** @override */
    activateListeners(html) {
        ...
        html.find('input[type="color"]').on("mouseenter mouseleave", e => {
            ...
            if ($(e.target).attr("name") === "done_selector")
                return;
            html.find("li.combatant").css("border-color", $(e.target).val());
        });
        html.find('button[name="reset"]').on("click", this.resetSettings.bind(this));
    }
    /** @override */
    async _updateObject(_, data) {
        game.settings.set(CONFIG.LancerInitiative.module, "appearance", diffObject(CONFIG.LancerInitiative.def_appearance, data, { inner: true }));
    }
    /**
...
//# sourceMappingURL=li-form.js.map