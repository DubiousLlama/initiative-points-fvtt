...
async function migrateSettings() {
    if (game.settings.get(CONFIG.LancerInitiative.module, "migrated") > 0)
        return;
    ...
    await game.settings.set(CONFIG.LancerInitiative.module, "appearance", diffObject(CONFIG.LancerInitiative.def_appearance, appearance));
